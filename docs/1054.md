...
Selenium网络驱动程序是Selenium工具套件最重要的组成部分。最新版本“Selenium 2.0”集成了 WebDriver API，提供了更简单、更简洁的编程界面。
...
*   [Selenium网络驱动教程](selenium-webdriver)
