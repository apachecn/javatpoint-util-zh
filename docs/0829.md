...
由于 UML 是一种 UML，它被用来为软件应用创建有意义的、面向对象的模型。它清楚地代表了任何硬件/软件系统的工作。有许多商业和开源工具可用于设计 UML 图，列举如下:
...
翁布里罗是一个基于 KDE 技术的 UML 工具。它支持 [C++](https://www.javatpoint.com/cpp-tutorial) 和 [Java](https://www.javatpoint.com/java-tutorial) 的逆向工程和代码生成。
