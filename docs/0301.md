...
在 Adobe Acrobat Reader DC 之前，单独的 ***【希伯来语】*** 和 ***【阿拉伯语】*** 版本是专门为这些语言开发的，通常从右向左书写。这些版本包含独特的 ***TouchUp*** 属性，用于管理从右到左的 ***中东*** 文字(如 ***波斯语、希伯来语、*** 和 ***阿拉伯语*** 以及标准的从左到右的 ***印第安语*** 文字(如 ***古JIRA特语】***
