...
现在，问题出现了，我们如何访问WebDriver提供的方法。

到目前为止，我们已经成功地在 Selenium WebDriver中创建了我们的第一个测试脚本。因此，查看 Webdriver 提供的方法的一种可能的方法是打开加载了 Selenium Webdriver jar 文件的 Eclipse IDE，为 WebDriver 创建一个驱动程序对象，然后按下圆点键。它将向您展示WebDriver提供的所有可能的方法。

![Selenium WebDriver Commands](img/36e0dcf1823620b17037bb95a071f8f7.png)

让我们从 Eclipse 显示的建议中考虑一个例子，以理解WebDriver提供的方法的语法。
...
下面给出了WebDriver中一些最常用的 Selenium 命令:
...
让我们考虑一个示例测试脚本，它将涵盖大多数常用的WebDriver命令。
