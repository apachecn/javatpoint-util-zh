...
*   [在 Visual Studio 中使用 NUnit 配置Selenium](#NUnit)
...
要在 C#中使用Selenium，请遵循以下过程:

*   **用 Visual Studio 在 C#中配置 Selenium】**
*   **在 Visual Studio 中使用 NUnit 配置Selenium**

## 用 Visual Studio 在 C#中配置Selenium
...
*   一旦我们点击下一步按钮，**配置您的新项目**窗口将出现在屏幕上，我们将提供我们的**项目名称【Selenium元素测试】，**并点击**创建**按钮，如下图所示:
...
按照以下过程，在 Visual Studio 中添加 Selenium WebDriver的引用:
...
*   在 Visual Studio 中添加了 Selenium WebDriver和 Chrome 驱动程序引用后，我们就可以用 C#编程语言编写测试脚本了。
...
### 用 NUnit 编写Selenium测试脚本

要使用 NUnit 编写Selenium测试脚本，请遵循以下过程:
