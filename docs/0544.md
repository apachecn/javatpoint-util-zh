...
| **$ GeoIP _ DMA _ code(ngx _ http _ GeoIP _ module)** | 根据谷歌广告词API中的地理定位，这是美国的码分多址(指定市场区)代码或地铁代码。 |
| **$ GeoIP _ DMA _ code(ngx _ stream _ GeoIP _ module)** | 根据谷歌广告词API中的地理定位，这是美国的码分多址(指定市场区)代码或地铁代码。 |
